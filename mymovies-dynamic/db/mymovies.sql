...
(4, 'We Are Your Friends ', 'We Are Your Friends est un film américain, réalisé par Max Joseph, sorti en 2015.', 'Cole, un DJ de 23 ans vit dans le milieu de l’électro et des nuits californiennes. La journée, il traîne avec ses amis d’enfance. La nuit il mixe, dans l’espoir de composer le son qui fera danser le monde entier. Son rêve semble alors possible lorsqu’il fait la connaissance de James, un DJ expérimenté, qui décide de le prendre sous son aile… ', 'Max Joseph', 2015, 'images/we_are_your_fri.96c53131733.original.jpg'),
(5, 'Le Cinquième Élément', 'Le Cinquième Élément est un film français de science-fiction réalisé par Luc Besson, sorti en 1997.', 'Au XXIII siècle, dans un univers étrange et coloré, où tout espoir de survie est impossible sans la découverte du cinquième élément, un héros affronte le mal pour sauver l\\\\''humanité.', 'Luc Besson', 1997, 'images/affich_496_1.jpg'),
(6, 'Pulp Fiction', 'Pulp Fiction est un film de gangsters américain réalisé par Quentin Tarantino et sorti en 1994.', 'L\\\\''odyssée sanglante, burlesque et cocasse de petits malfrats dans la jungle de Hollywood à travers trois histoires qui s\\\\''entremêlent.', 'Quentin Tarantino', 1994, 'images/p15684_p_v8_ac.jpg'),
...
(11, 'Profession profiler ', 'Profession profiler est un film américain réalisé par Renny Harlin, sorti en 2004.\r\n', 'Afin de valider leurs acquis, sept jeunes profilers sont envoyés par leur instructeur sur une île pour y simuler une véritable enquête. Seulement, un véritable tueur se cache sur l\\\\''île en question, et le simulacre d\\\\''enquête tourne très vite au massacre', 'Renny Harlin', 2004, 'images/profession profiler.jpg'),
(12, 'Conjuring : Les Dossiers Warren', 'Conjuring : Les Dossiers Warren est un film d\\\\''horreur américain réalisé par James Wan, sorti en 2013.', 'Conjuring : Les dossiers Warren, raconte l\\\\''histoire horrible, mais vraie, d\\\\''Ed et Lorraine Warren, enquêteurs paranormaux réputés dans le monde entier, venus en aide à une famille terrorisée par une présence inquiétante dans leur ferme isolée… Contraints d\\\\''affronter une créature démoniaque d\\\\''une force redoutable, les Warren se retrouvent face à l\\\\''affaire la plus terrifiante de leur carrière…', 'James Wan', 2013, 'images/Conjuring-Les-Dossiers-Warren-Affiche-France.jpg');
